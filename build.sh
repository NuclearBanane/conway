...
FILES="src/e_game.c  src/e_game.h  src/emain.c  src/game.c  src/game.h  src/main.c"
...
${CROSS_PREFIX}gcc ${FILES} -o ./build/main.elf  -std=c99 ${EINCS} ${ELIBS} -le-hal -le-loader -lpthread
